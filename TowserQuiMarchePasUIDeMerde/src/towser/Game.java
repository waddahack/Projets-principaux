...
public class Game {
    ...
    private void initOverlays(){
        ...
        o.setBG(null);
        o.addButton(new Button(o.getW()-100, 25, 200, 50, "Lancer la vague", "brown"));
        overlays.add(o);
        
        o = new Overlay(0, Towser.windHeight-2*unite, Towser.windWidth, 2*unite);
        o.setMargin(25);
        o.addButton(new Button(0, 0, Game.unite, Game.unite, null, "blue"));
        b = o.getButtons().get(0);
        b.setBG(Towser.getTexture("basicTower"));
        o.addButton(new Button(b.getX()+b.getW(), 0, Game.unite, Game.unite, null, "blue"));
        b = o.getButtons().get(1);
        b.setBG(Towser.getTexture("circleTower"));
        overlays.add(o);
